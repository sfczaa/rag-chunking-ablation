...
fix in the upstream advisory as of 2026-09-13. It concerns model import/export
...
containment review. A dependency scan can still report this advisory. The
Space requirements do not include NLTK; corpus preparation uses `punkt_tab`.
See the [upstream advisory](https://github.com/nltk/nltk/security/advisories/GHSA-8mgp-746c-j5xp).
