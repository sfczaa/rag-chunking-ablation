...
- yes - 2. method difference unresolved at matched (large) chunk size: max method spread of recall@5 over the size-15 cells - observed 0.02 (rule: max spread < 2 SE (0.0355); NQ reference: NQ stage3: spread 0.020 at size 15/ov0 (~1 SE = 0.019))
