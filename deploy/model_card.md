...
On the tested TriviaQA bench, the off-the-shelf reranker lowered R@1 by
0.03...0.07 relative to dense retrieval. This model returned to approximately
the dense baseline. Its difference from the off-the-shelf reranker was positive
at 5/5 configs and above the approximate 2 SE band at 4/5 configs, but the
cross-dataset result remained approximately equal to dense retrieval.

The reported improvement is specific to NQ. The TriviaQA result does not
establish expected behavior on other datasets.
